        ...
        {index < WORDS.length && (
          ...
          >
            ...
            <p className="text-3xl font-light text-white md:text-4xl">
              {WORDS[index]}
            <p className="text-[0.65rem] tracking-[0.5em] uppercase text-white/60 mb-6">
              Discovery / Observation / Manifest
            </p>
            <div className="relative px-6">
              <span className="absolute inset-0 translate-x-1 -translate-y-1 text-4xl md:text-6xl lg:text-7xl font-semibold text-cyan-400/25 blur-sm">
                {WORDS[index]}
              </span>
              ...
              <p className="relative text-4xl md:text-6xl lg:text-7xl font-semibold tracking-wide text-transparent bg-clip-text bg-gradient-to-br from-white via-cyan-200 to-fuchsia-300 drop-shadow-[0_0_35px_rgba(56,189,248,0.55)]">
                {WORDS[index]}
              </p>
            </div>
            <div className="mt-6 flex items-center gap-3 text-[0.7rem] tracking-[0.45em] uppercase text-white/40">
